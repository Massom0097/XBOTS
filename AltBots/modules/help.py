...
HELP_STRING = f"★ 𝘽𝙖𝙖𝙥 𝙃𝙚𝙡𝙥 𝙈𝙚𝙣𝙪 ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @sexyaaditya**"
...
HELP_BUTTON = [
    ...
    [
      Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/sexyaaditya"),
      Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/BaapOnFire")
    ]
  ]
    ...
    if event.sender_id in SUDO_USERS:
        try:
          await event.client.send_file(event.chat_id,
              "https://telegra.ph/file/5eb54b3b5c900b2fae835.jpg",
              caption=HELP_STRING,
              buttons=HELP_BUTTON
              )
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Make Your Own Altron Bots !! @sexyaaditya", cache_time=0, alert=True)
...
async def help_spam(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Make Your Own Laura !! @sexyaaditya", cache_time=0, alert=True)
